...
public class XmlDiffUtils {
	 ...
	 * @return
	 */
	public XmlDiffUtils printLog(boolean printLog) {
	 ...
	 * @return
	 */
	public XmlDiffUtils ignoreTag(String node) {
	 ...
	 * @return
	 */
	public XmlDiffUtils ignoreAttribute(String attribute) {
	 ...
	 * @return
	 */
	public XmlDiffUtils diff(String src, String dest) {
